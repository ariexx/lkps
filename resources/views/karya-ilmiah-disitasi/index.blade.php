...
@section("content")
    <x-adminlte-card title="Karya Ilmiah DTPS Disitasi">
        <x-create-button route="{{ auth()->user()->role == 'dosen' ? route('dosen.kinerja-dosen.karya-ilmiah-dtps-disitasi.create') : route('kepala-prodi.sumber-daya-manusia.karya-ilmiah-dtps-disitasi.create') }}">
            Tambah
        </x-create-button>
