...
@section("title", "Edit HKI Hak Cipta")

@section("content_header")
    <h1>Edit HKI Hak Cipta</h1>
@stop

@section("content")
    <x-adminlte-card>
        <form action="{{ route('kepala-prodi.sumber-daya-manusia.luaran-penelitian-pkm-hki-hak-cipta.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
