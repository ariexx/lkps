...
@section("title", "Edit Pagelaran Ilmiah")

@section("content_header")
    <h1>Edit Pagelaran Ilmiah</h1>
@stop

@section("content")
    <x-adminlte-card>
        <form action="{{ route('kepala-prodi.sumber-daya-manusia.pagelaran-ilmiah-dtps.update', $data->id) }}" method="POST">
            @csrf
            @method('PUT')
